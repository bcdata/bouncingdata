...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/bouncingdata/login.css" />" />
<link type="text/css"
...
<script type="text/javascript"
	src="<c:url value="/resources/js/bouncingdata/login.js" />"></script>
<style>
				...
				<div id="login">
					...
					<div class="message">
						<c:if test="${not empty error}">
							<div class="error-block" id="error-msg">Your login attempt
								was not successful, try again.</div>
						</c:if>
					</div>
					<div class="login-form">
						<form name='f' action="<c:url value='/auth/security_check' />"
							method='post'>
							<label>Username</label>
							<input class="input-field" type='text' name='j_username'
								id='username' maxlength="40"></input>
							<label>Password</label>
							<input class="input-field" type='password' name='j_password'
								id='password' maxlength="100"></input>
							<div class="login-actions">
								<input type="submit" name="submit" value="Login"
									onclick="if ($('#username').val().length <= 0 || $('#password').val().length <= 0) return false; else return true;" />
				...
				<div id="signup">
					...
					<div class="register-form">
						<form action="<c:url value='/auth/register' />" method="post">
							<div>
								<label for='register-username'>Username</label> <input
									class="input-field" type='text' name='username'
									id='reg-username' maxlength="40"></input>
							</div>
							<div>
								<label for='reg-password'>Password</label> <input
									class="input-field" type='password' name='password'
									id='reg-password' maxlength="100"></input>
							</div>
							<div>
								<label for='reg-password2'>Re-type Password</label> <input
									class="input-field" type='password' name='password2'
									id='reg-password2' maxlength="100"></input>
							</div>
							<div>
								<label for='reg-email'>Email</label> <input class="input-field"
									type='text' name='email' id='reg-email' maxlength="100"></input>
							</div>

							<div class="reg-actions">
								<input type="submit" name="submit" value="Submit"
									onclick="if ($('#reg-username').val().length <= 0 || $('#reg-password').val().length <= 0 || $('#reg-email').val().length <= 0) return false; else return true;" />
    ...
    -->
		...
		<div class="footer">
			<div class="footer-content">
				<a href="#" class="footer-link">Term of Service</a> <a href="#"
					class="footer-link">Privacy Policy</a> <a href="#"
					class="footer-link">Help</a>
				<div class="footer-right">
					<span>Copyright &copy;2012 bouncingdata.com. All rights
						reserved.</span>
				</div>
			</div>
		</div>
	...
	<div id="dialog-message" title="Reset your password">
		<p>
			<span class="ui-icon ui-icon-circle-check"
				style="float: left; margin: 0 7px 50px 0;"></span> A confirm mail is
